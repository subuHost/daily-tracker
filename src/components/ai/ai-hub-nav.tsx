...
export function AiHubNav() {
    ...
    return (
        <>
            ...
            <div className="md:hidden overflow-x-auto flex gap-2 px-4 py-3 border-b bg-background/80 backdrop-blur-sm scrollbar-hide">
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? cn(item.activeBg, item.activeText, "shadow-sm")
            ...
            <nav className="hidden md:flex flex-col gap-0.5 p-3 pt-4">
